...
public class PnMadeira extends JPanel {
	...
	public void AtualizaTabela(ArrayList<Madeira> list){
		...
		for (Madeira madeira : list) {
			tableModel.addRow(new String[] {madeira.getId()+"",madeira.getNome(),madeira.getValor()+""});
		}
	}
	
	public Madeira getObjetoTela(){
		return new Madeira(Integer.parseInt(txtId.getText()),txtNome.getText(),Double.parseDouble(txtValor.getText()));
	}
