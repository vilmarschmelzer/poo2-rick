...
public class PnCaracteristica extends JPanel {
	...
	public void AtualizaTabela(ArrayList<Caracteristica> list){
		...
		for (Caracteristica carac : list) {
			tableModel.addRow(new String[] {carac.getId()+"",carac.getNome(),carac.getValor()+""});
		}
	}
	
	public Caracteristica getObjetoTela(){
		return new Caracteristica(Integer.parseInt(txtId.getText()),txtNome.getText(),Double.parseDouble(txtValor.getText()));
	}
